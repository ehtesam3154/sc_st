...
Train on P2 ST1 and ST2, with multi-patient encoder alignment (P2 + P10 SC data).
...
def parse_args():
    ...
    parser.add_argument('--outdir', type=str, default='gems_hscc_p2all_output')
...
def load_multipatient_data():
    ...
    print(f"  P2_ST1: {stadata1.n_obs} cells")
    print(f"  P2_ST2: {stadata2.n_obs} cells")
...
def main(args=None):
    ...
    if args.anchor_train and 'anchored' not in outdir:
        outdir = outdir.replace('gems_hscc_p2all_output', 'gems_hscc_p2all_output_anchored')
